...
# Import the FastAgent class from the app
sys.path.append(str(Path(__file__).parent.parent))
from app.agent_base import FastAgent
...
def start_rebel_agent():
    """Start the Agent Rebel (agent_0) process."""
    ...
    uvicorn.run(
        "app.agent_0:app", host="0.0.0.0", port=7999, reload=False, log_level="info"
    )
